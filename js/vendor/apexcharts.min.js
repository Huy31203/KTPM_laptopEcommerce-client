        ...
        r(t, [
          {
            ...
            value: function (t, e, i, a) {
              ...
              o &&
                ...
                void 0 !== d &&
                  (h = d(l, t[a], { i: a, dateFormatter: new T(this.ctx).formatDate, w: n })));
              var p = function (t) {
                var i = null;
                return (
            ...
            value: function (t) {
              ...
              if (
                ...
                (b = (v = this.closestInMultiArray(k, A, m, y)).index),
                  (f = v.j),
                  null !== b &&
                    ((m = r.globals.seriesXvalues[b]), (f = (v = this.closestInArray(k, m)).index));
              }
              return (
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                ...
                if (
                  (m.setAttrs(T.node, { 'data:angle': L, 'data:value': t.series[p] }),
                  e.config.chart.dropShadow.enabled)
                ) {
            ...
            value: function (t) {
              ...
              if (e.minDate > 1) {
                ...
                0 === n && ((c = 'year'), (f = g), (u = 1), (g += d += 1)),
                  this.timeScaleArray.push({ position: l, value: f, unit: c, year: g, month: u });
              } else
                this.timeScaleArray.push({
                  position: l,
                  value: n,
